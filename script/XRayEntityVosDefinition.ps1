...
$ConfigFile = Get-IniContent 'C:\Users\bhansm\Desktop\JUnitXRayIntegration\config\config.ini'
...
class XrayTestExecutionEntityVo{
    ...
    create(){
        ...
        $body = @{
            "info" = @{
            "summary" = $this.name + "(Created during importing junit result using REST at " + $(Get-Date).ToString([Constants]::currentDateFormat) + ")";
    ...
    create(){
        ...
        $body = @{
            fields = @{
                ...
                "summary" = "Created during Junit-XRay Integration using REST at " + $(Get-Date).ToString([Constants]::currentDateFormat);
                "description" = "Created during Junit-XRay Integration using REST at " + $(Get-Date).ToString([Constants]::currentDateFormat);
                "issuetype" = @{
                    "name" = "Test Plan"
                 };
